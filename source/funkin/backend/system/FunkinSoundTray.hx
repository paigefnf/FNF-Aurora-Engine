...
class FunkinSoundTray extends FlxSoundTray
{
	...
	public function new()
	{
		...
		var bg:Bitmap = new Bitmap(getPathImage("game/soundtray/volumebox"));
		...
		var backingBar:Bitmap = new Bitmap(getPathImage('game/soundtray/bars_10'));
		backingBar.x = 9;
		backingBar.y = 5;
		...
		for (i in 1...11)
		{
			var bar:Bitmap = new Bitmap(getPathImage('game/soundtray/bars_$i'), false);
			bar.x = 9;
			bar.y = 5;
