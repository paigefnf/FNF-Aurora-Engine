...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			case 'gf':
				// GIRLFRIEND CODE
				tex = Paths.getSparrowAtlas('characterAssets/GF_assets', 'shared');
				frames = tex;
			...
			case 'gf-christmas':
				tex = Paths.getSparrowAtlas('characterAssets/gfChristmas', 'shared');
				frames = tex;
				animation.addByPrefix('cheer', 'GF Cheer', 24, false);
				animation.addByPrefix('singLEFT', 'GF left note', 24, false);
				animation.addByPrefix('singRIGHT', 'GF Right Note', 24, false);
			...
			case 'gf-car':
				tex = Paths.getSparrowAtlas('characterAssets/gfCar', 'shared');
				frames = tex;
			...
			case 'gf-pixel':
				tex = Paths.getSparrowAtlas('characterAssets/gfPixel', 'shared');
				frames = tex;
			...
			case 'gf-tankmen':
				frames = Paths.getSparrowAtlas('characterAssets/gfTankmen', 'shared');
			...
			case 'pico-speaker':
				...
				tex = Paths.getSparrowAtlas('characterAssets/picoSpeaker', 'shared');
				frames = tex;
			...
			case 'dad':
				...
				tex = Paths.getSparrowAtlas('characterAssets/DADDY_DEAREST', 'shared');
				frames = tex;
			...
			case 'spooky':
				tex = Paths.getSparrowAtlas('characterAssets/spooky_kids_assets', 'shared');
				frames = tex;
			...
			case 'mom':
				tex = Paths.getSparrowAtlas('characterAssets/Mom_Assets', 'shared');
				frames = tex;
			...
			case 'mom-car':
				tex = Paths.getSparrowAtlas('characterAssets/momCar', 'shared');
				frames = tex;
			...
			case 'monster':
				tex = Paths.getSparrowAtlas('characterAssets/Monster_Assets', 'shared');
				frames = tex;
			...
			case 'monster-christmas':
				tex = Paths.getSparrowAtlas('characterAssets/monsterChristmas', 'shared');
				frames = tex;
				animation.addByPrefix('idle', 'monster idle', 24, false);
				animation.addByPrefix('singUP', 'monster up note', 24, false);
				animation.addByPrefix('singDOWN', 'monster down', 24, false);
			...
			case 'pico':
				tex = Paths.getSparrowAtlas('characterAssets/Pico_FNF_assetss', 'shared');
				frames = tex;
			...
			case 'bf':
				var tex = Paths.getSparrowAtlas('characterAssets/BOYFRIEND', 'shared');
				frames = tex;
			...
			case 'bf-christmas':
				var tex = Paths.getSparrowAtlas('characterAssets/bfChristmas', 'shared');
				frames = tex;
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
				animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
			...
			case 'bf-car':
				var tex = Paths.getSparrowAtlas('characterAssets/bfCar', 'shared');
				frames = tex;
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
				animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
			...
			case 'bf-pixel':
				frames = Paths.getSparrowAtlas('characterAssets/bfPixel', 'shared');
			...
			case 'bf-pixel-dead':
				frames = Paths.getSparrowAtlas('characterAssets/bfPixelsDEAD', 'shared');
			...
			case 'bf-holding-gf':
				...
				frames = Paths.getSparrowAtlas('characterAssets/bfAndGF', 'shared');
			...
			case 'bf-holding-gf-DEAD':
				...
				frames = Paths.getSparrowAtlas('characterAssets/bfHoldingGF-DEAD', 'shared');
			...
			case 'senpai':
				frames = Paths.getSparrowAtlas('characterAssets/senpai', 'shared');
			...
			case 'spirit':
				frames = Paths.getPackerAtlas('characterAssets/spirit', 'shared');
			...
			case 'tankman':
				tex = Paths.getSparrowAtlas('characterAssets/tankmanCaptain', 'shared');
				frames = tex;
			...
			case 'parents-christmas':
				frames = Paths.getSparrowAtlas('characterAssets/mom_dad_christmas_assets', 'shared');
